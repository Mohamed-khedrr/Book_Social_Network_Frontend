...
export { BorrowedBooksResponse } from './models/borrowed-books-response';
...
export { PageResponseBorrowedBooksResponse } from './models/page-response-borrowed-books-response';
