...
import { getBookFeedback } from '../fn/feedback/get-book-feedback';
import { GetBookFeedback$Params } from '../fn/feedback/get-book-feedback';
...
export class FeedbackService extends BaseService {
  ...
  /** Path part for operation `getBookFeedback()` */
  static readonly GetBookFeedbackPath = '/feedback/book/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getBookFeedback()` instead.
   *
   * This method doesn't expect any request body.
   */
  getBookFeedback$Response(params: GetBookFeedback$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFeedbackResponse>> {
    return getBookFeedback(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getBookFeedback$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getBookFeedback(params: GetBookFeedback$Params, context?: HttpContext): Observable<PageResponseFeedbackResponse> {
    return this.getBookFeedback$Response(params, context).pipe(
